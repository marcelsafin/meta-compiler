...
const renderSectionContent = (content: string, type: GenerationType) => {
    if (type === GenerationType.DIAGRAM) {
                ...
                return (
                    <div key={type} className="bg-gray-800 border border-gray-700 rounded-lg shadow-inner">
                        ...
                        <div className="p-4 overflow-x-auto">
                          {renderSectionContent(rawContent, type)}
                        </div>
                    </div>
                );
            })}
